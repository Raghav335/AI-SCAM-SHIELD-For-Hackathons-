  ...
  const handleScan = async () => {
    ...
    try {
      const response = await fetch(
        "https://ai-scam-shield-upkl.onrender.com/api/scan/url",
        {
          method: "POST",
          headers: {
      ...
      <main className="max-w-6xl mx-auto px-5 sm:px-8 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-2 max-w-2xl">
            Analyze suspicious URLs using AI-powered threat detection and
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-7">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold">Scan a URL</h3>
            ...
            >
              {loading ? "Checking URL..." : "🛡️ Scan URL →"}
            </button>
          </div>
          ...
          <div className="bg-[#edf3eb] rounded-3xl border border-green-900/5 p-7">
            ...
            <p className="text-sm text-slate-600 mt-2">
              AI Scam Shield analyzes the URL and provides security and
              network intelligence.
            </p>
              ...
              <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-7">
                ...
                <div className="mt-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 mt-5">
                    ...
                    <NetworkItem
                      title="SERVER IP"
                      value={getValue(result.ip)}
                      icon="📡"
                    />

                    <NetworkItem
                      title="ISP / HOSTING"
                      value={getValue(result.isp)}
                      icon="🏢"
                    />

                    <NetworkItem
                      title="ASN"
                      value={getValue(result.asn)}
                      icon="🔢"
                    />

                    <NetworkItem
                      title="SERVER LOCATION"
                      value={getValue(result.location)}
                      icon="🌍"
                    />
                  ...
                  <div className="mt-3 bg-[#fbfaf5] border border-slate-100 rounded-2xl p-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-bold mt-1">
                        {getValue(result.redirects, "0")} redirect(s)
                        detected
                      </p>
                    </div>
                ...
                <div className="mt-4 bg-[#edf3eb] rounded-2xl p-5">
                  ...
                  <p className="mt-3 text-sm text-slate-600 leading-relaxed">
                    {getValue(result.recommendation)}
                  </p>
                </div>
              </div>
            </div>
...
function NetworkItem({ title, value, icon }) {
  return (
